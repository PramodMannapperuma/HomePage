...
//                   context,
//                   MaterialPageRoute(
//                     builder: (context) => ArticleDetail(article: article, comments: [],),
//                   ),
//                 );
//               },
//             ),
  ...
  final List<Map<String, String>> newsArticles = [
    {
      ...
      'description': 'Date is June 10.',
      'image':
          'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.istockphoto.com%2Fphotos%2Fmonday&psig=AOvVaw1XxEauYShwHE6QJgs3SXFg&ust=1718172308313000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCKCHmOPw0oYDFQAAAAAdAAAAABAH'
    },
    {
      'title': 'Happy Birthday',
      'description': 'Today is your birthday.',
      'image':
          'https://www.google.com/url?sa=i&url=https%3A%2F%2Fstock.adobe.com%2Fsearch%3Fk%3Dhappy%2Bbirthday&psig=AOvVaw2E3U0iqEEsdlYg7klsC7py&ust=1718172366733000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCMDsgP_w0oYDFQAAAAAdAAAAABAE'
    },
    {
      'title': 'Tomorrow is Tuesday!',
      'description': 'Date is June 11.',
      'image':
          'https://www.google.com/url?sa=i&url=https%3A%2F%2Fstock.adobe.com%2Fsearch%2Fimages%3Fk%3D%2522happy%2Btuesday%2522&psig=AOvVaw2NjlnrQJor7NN7Zr-s_fBB&ust=1718172423444000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCKjOkpnx0oYDFQAAAAAdAAAAABAE'
    },
  ];

  List<List<String>> commentsList =
      List.filled(3, []); // Initialize empty comment lists
            ...
            child: ListTile(
              leading: SizedBox(
                ...
                child: Image.network(
                  article['image']!,
                  fit: BoxFit
                      .cover, // ensures the image covers the SizedBox area
                ),
              ),
              title: Text(article['title']!),
              subtitle: Text(article['description']!),
