...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    var textFieldHeight = screenHeight * 0.05; // Adjust based on screen height
    var buttonHeight = screenHeight * 0.05;
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: screenHeight * 0.1), // Bottom padding
            ],
          ),
        ),
      ),
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.symmetric(vertical: 5.0), // Add padding here
